    ...
    <View style={styles.container}>
      ...
      <View style={styles.infoBlock}>
        ...
        <View style={styles.infoContent}>
          ...
          <Text style={styles.infoText}> 012 34 567 890 </Text>

          {/* Linha para "Amil S750" e Data */}
          <View style={styles.row}>
            <Text style={styles.amilText}>SulAmérica Kids</Text>
            <Text style={styles.dateText}>15 / 05 / 2025</Text>
          </View>


          <Text style={styles.subInfoText}>Empresarial sem coop.</Text>
        </View>
      </View>
    </View>
  );
