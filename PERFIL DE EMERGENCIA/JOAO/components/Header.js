  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.whiteContainer}>
        ...
        <Image source={require('../assets/imagem_perfil_2.png')} style={styles.leftCircle} />

        {/* Nome e Sobrenome */}
        <View style={styles.nameContainer}>
          <Text style={styles.firstName}>Antônio</Text>
          <Text style={styles.lastName}>Ferreira dos Santos</Text>
        </View>
