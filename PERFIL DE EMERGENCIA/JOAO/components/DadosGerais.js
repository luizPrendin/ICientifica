      ...
      description: [
        {
          ...
          indication: 'Controle da pressão arterial. Posologia: 1 comprimido por dia..',
          posology: '',
          observation: ''
        },
        {
          name: 'Atenolol (25 mg)',
          indication: 'Controle de hipertensão. Posologia: 1 comprimido por dia.',
          posology: '',
          observation: ''
        },
      ]
      ...
      description: [
        {
          ...
          details: ' Reação alérgica severa, risco de anafilaxia.'
        },
      ]
    },
    restriction: {
      ...
      description: [
        {
          ...
          details: 'Dificuldade de locomoção, necessita de bengala para caminhar.'
        },
      ]
    },
    warning: {
      ...
      description: [
        {
          name: 'Histórico de AVC:',
          details: 'Atenção redobrada em caso de tontura ou perda de coordenação.'
        },
      ]
    },
  };
