  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.whiteContainer}>
        ...
        <Image source={require('../assets/imagem_perfil_1.png')} style={styles.leftCircle} />

        {/* Nome e Sobrenome */}
        <View style={styles.nameContainer}>
          <Text style={styles.firstName}>Isadora</Text>
          <Text style={styles.lastName}>Martins Oliveira</Text>
        </View>
