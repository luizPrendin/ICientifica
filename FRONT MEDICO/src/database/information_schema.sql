...
`CLIENT` varchar(64)
,`TOTAL_CONNECTIONS` bigint(21) unsigned
,`CONCURRENT_CONNECTIONS` bigint(21) unsigned
,`CONNECTED_TIME` bigint(21) unsigned
,`BUSY_TIME` bigint(21) unsigned
,`CPU_TIME` bigint(21) unsigned
,`BYTES_RECEIVED` bigint(21) unsigned
,`BYTES_SENT` bigint(21) unsigned
,`BINLOG_BYTES_WRITTEN` bigint(21) unsigned
,`ROWS_FETCHED` bigint(21) unsigned
,`ROWS_UPDATED` bigint(21) unsigned
,`TABLE_ROWS_READ` bigint(21) unsigned
,`SELECT_COMMANDS` bigint(21) unsigned
,`UPDATE_COMMANDS` bigint(21) unsigned
,`OTHER_COMMANDS` bigint(21) unsigned
,`COMMIT_TRANSACTIONS` bigint(21) unsigned
,`ROLLBACK_TRANSACTIONS` bigint(21) unsigned
,`DENIED_CONNECTIONS` bigint(21) unsigned
,`LOST_CONNECTIONS` bigint(21) unsigned
,`ACCESS_DENIED` bigint(21) unsigned
,`EMPTY_QUERIES` bigint(21) unsigned
...
--
-- Stand-in structure for view `GLOBAL_TEMPORARY_TABLES`
-- (See below for the actual view)
--
CREATE TABLE `GLOBAL_TEMPORARY_TABLES` (
`SESSION_ID` bigint(4)
,`TABLE_SCHEMA` varchar(64)
,`TABLE_NAME` varchar(64)
,`ENGINE` varchar(64)
...
,`INFO` longtext
,`TIME_MS` bigint(21)
,`ROWS_SENT` bigint(21) unsigned
,`ROWS_EXAMINED` bigint(21) unsigned
);
...
,`TABLE_NAME` varchar(192)
,`ROWS_READ` bigint(21) unsigned
,`ROWS_CHANGED` bigint(21) unsigned
,`ROWS_CHANGED_X_INDEXES` bigint(21) unsigned
);

-- --------------------------------------------------------

--
-- Stand-in structure for view `TEMPORARY_TABLES`
-- (See below for the actual view)
--
...
--
-- Stand-in structure for view `THREAD_STATISTICS`
-- (See below for the actual view)
--
...
,`physical_page_size` bigint(21) unsigned
,`logical_page_size` bigint(21) unsigned
,`is_compressed` tinyint(1) unsigned
...
--
-- Stand-in structure for view `XTRADB_ZIP_DICT`
-- (See below for the actual view)
--
CREATE TABLE `XTRADB_ZIP_DICT` (
`id` bigint(21) unsigned
,`name` varchar(64)
,`zip_dict` blob
);
...
--
-- Stand-in structure for view `XTRADB_ZIP_DICT_COLS`
-- (See below for the actual view)
--
CREATE TABLE `XTRADB_ZIP_DICT_COLS` (
`table_id` bigint(21) unsigned
,`column_pos` bigint(21) unsigned
,`dict_id` bigint(21) unsigned
);
...
--
-- Structure for view `GLOBAL_TEMPORARY_TABLES`
--
...
--
-- Structure for view `TEMPORARY_TABLES`
--
...
--
-- Structure for view `THREAD_STATISTICS`
--
...
CREATE TEMPORARY TABLE `USER_STATISTICS` (
  `USER` varchar(96) NOT NULL DEFAULT '',
  `TOTAL_CONNECTIONS` bigint(21) UNSIGNED NOT NULL DEFAULT '0',
  `CONCURRENT_CONNECTIONS` bigint(21) UNSIGNED NOT NULL DEFAULT '0',
  `CONNECTED_TIME` bigint(21) UNSIGNED NOT NULL DEFAULT '0',
  `BUSY_TIME` bigint(21) UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TEMPORARY TABLE `XTRADB_RSEG` (
  ...
  `physical_page_size` bigint(21) UNSIGNED NOT NULL DEFAULT '0',
  `logical_page_size` bigint(21) UNSIGNED NOT NULL DEFAULT '0',
  `is_compressed` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Structure for view `XTRADB_ZIP_DICT`
--
DROP TABLE IF EXISTS `XTRADB_ZIP_DICT`;

CREATE TEMPORARY TABLE `XTRADB_ZIP_DICT` (
  `id` bigint(21) UNSIGNED NOT NULL DEFAULT '0',
  `name` varchar(64) NOT NULL DEFAULT '',
  `zip_dict` blob NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Structure for view `XTRADB_ZIP_DICT_COLS`
--
DROP TABLE IF EXISTS `XTRADB_ZIP_DICT_COLS`;

CREATE TEMPORARY TABLE `XTRADB_ZIP_DICT_COLS` (
  `table_id` bigint(21) UNSIGNED NOT NULL DEFAULT '0',
  `column_pos` bigint(21) UNSIGNED NOT NULL DEFAULT '0',
  `dict_id` bigint(21) UNSIGNED NOT NULL DEFAULT '0'
) ENGINE=MEMORY DEFAULT CHARSET=utf8;
COMMIT;
